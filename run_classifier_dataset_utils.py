...
import pickle
with open('/hdd/user4/XLNet/data/odp/label_key.pkl', 'rb') as f:
    odp_label = pickle.load(f)
str_odp_label = []
for i in odp_label:
    str_odp_label.append(str(i))


class ODPProcessor(DataProcessor):
  def get_train_examples(self, data_dir):
    return self._create_examples(os.path.join(data_dir, "train_converted.csv"))

  def get_dev_examples(self, data_dir):
    return self._create_examples(os.path.join(data_dir, "NYT_test_converted.csv"))
...
def WWW_acc_mi_ma(preds, labels, nb_classes):
...
def compute_metrics(task_name, preds, labels):
    ...
    if task_name == "cola":
        ...
        nb_classes = 2531
        return {"acc": WWW_acc_mi_ma(preds, labels, nb_classes)}
    elif task_name == "mrpc":
